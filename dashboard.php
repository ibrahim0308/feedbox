<?php
// we are starting the session again
session_start();
// Include database connection file
include_once('config.php');

if (!isset($_SESSION['ID'])) {
    // we're logging in with this ID then we're going to the dashboard
...
<html lang="en">
    <head>
      ...
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="" style="color: #5b5757;"><b>FoodSales</b></a>
               <ul class="navbar-nav px-3">
         <li class="nav-item text-nowrap">
             <!-- php code for log out functionality -->
      ...
      <div class="container-fluid">
         ...
         <nav class="col-md-2 d-none d-md-block bg-info sidebar" style="height: 569px">
               ...
               <span data-feather="home"></span>
                ...
                <!-- if session role admin we will see admin page -->
      ...
      <div class="table-responsive">
        <table class="table table-striped">
         ...
         <?php
            ...
            $role = $_SESSION['ROLE'];
            $query = "SELECT * FROM kullanicilar WHERE role = '$role'";
             }
